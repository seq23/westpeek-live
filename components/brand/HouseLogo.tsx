 ...
 */
export async function HouseLogo({ size = "md", inverse = false, className = "" }: { size?: "sm" | "md" | "lg"; inverse?: boolean; className?: string }) {
  ...
  if (!src) return <WestPeekProductionsLogoHomeLink size={size} inverse={inverse} className={className} />;
