...
/**
 * @seed-view — the demo/seed branch of the run-of-show page. Its segments, cues and approvals are
 * the demo summit's fixtures, which is what a demo event is for. A real runtime event renders its
 * own sessions in RunOfShowPage instead.
 */
export function RunOfShowSeedView({ eventId }: { eventId: string }) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-brand-line bg-white p-4 shadow-sm sm:p-6">
        <p className="text-sm font-medium text-slate-500">Run of show · demo event</p>
