    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm" data-testid="speaker-roster">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-2xl bg-slate-50 p-4" data-testid="vip-room-control" data-open={vipRoom.open ? "true" : "false"}>
          ...
          <p className="text-xs text-slate-600">{vipRoom.open ? (vipRoom.updatedBy === "default" ? "Open by default · VIPs see it in the lobby" : `Open · VIPs see it in the lobby · by ${vipRoom.updatedBy}`) : `Closed · VIPs see only their badge · by ${vipRoom.updatedBy}`} · {vips.length} VIP{vips.length === 1 ? "" : "s"} named</p>
