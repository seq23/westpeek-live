...
| `validate:attendee-roster-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:end-show-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:speaker-green-room-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:crew-role-permissions-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:view-as-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:venue-follows-event-state` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:speed-networking-real-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:fail-soft-sections` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:access-codes-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:readable-access-codes` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:vip-is-code-bound` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:access-codes-vault-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:people-hash-only-contract` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:people-real-rows-first` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:event-workspace-spine` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:no-person-name-as-actor` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
...
| `validate:worker-variable-budget` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:migration-mirror-parity` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
| `validate:migration-map-coverage` | umbrella_or_legacy_chain | HARD FAIL | Repo owner / release operator | static_validation | `validate:deploy-parity` | HARD FAIL blocks only when the script is selected by the active tier/profile; INFO rows are diagnostic. |
