...
/** Onboarding is the identity step: who you are, then the checklist. */
export default async function SpeakerOnboardingPage({ params, searchParams }: { params: Promise<{ eventId: string }>; searchParams?: Promise<{ error?: string }> }) {
