...
const requiredColumns = {
  ...
  speed_networking_entries: ["id", "event_id", "attendee_id", "display_name", "company", "title", "status", "joined_at", "matched_at", "match_id", "matches_completed", "updated_at"],
  speed_networking_matches: ["id", "event_id", "attendee_a_id", "attendee_b_id", "normalized_pair_key", "room_name", "status", "starts_at", "expires_at", "ended_at", "ended_reason"],
